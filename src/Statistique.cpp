...
// Constructeur
Stats::Stats() : faim(100.0f), joie(50.0f), sante(100.0f), energie(100.0f) {} //le f a coter de 100.0 signifie float
...
// Setters
void Stats::setFaim(float v) { faim = std::max(0.0f, std::min(v, 100.0f)); }
